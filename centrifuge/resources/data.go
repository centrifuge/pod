...
func resourcesDefault_configYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/default_config.yaml", size: 1849, mode: os.FileMode(420), modTime: time.Unix(1538407216, 0)}
...
func resourcesTesting_configYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/testing_config.yaml", size: 958, mode: os.FileMode(420), modTime: time.Unix(1539078796, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

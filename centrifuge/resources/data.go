...
func resourcesDefault_configYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/default_config.yaml", size: 1632, mode: os.FileMode(420), modTime: time.Unix(1529577406, 0)}

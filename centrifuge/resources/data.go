...
func resourcesDefault_configYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/default_config.yaml", size: 2387, mode: os.FileMode(420), modTime: time.Unix(1540394759, 0)}

...
func (*CreatePurchaseOrderProofEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_0337b03eabe0f93b, []int{0}
}
...
func (*PurchaseOrderProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_0337b03eabe0f93b, []int{1}
}
...
func (*AnchorPurchaseOrderEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_0337b03eabe0f93b, []int{2}
}
...
func (*SendPurchaseOrderEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_0337b03eabe0f93b, []int{3}
}
...
func (*GetPurchaseOrderDocumentEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_0337b03eabe0f93b, []int{4}
}
...
func (*ReceivedPurchaseOrders) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_0337b03eabe0f93b, []int{5}
}
...
func init() {
	proto.RegisterFile("legacy/purchaseorder/service.proto", fileDescriptor_service_0337b03eabe0f93b)
}

var fileDescriptor_service_0337b03eabe0f93b = []byte{
	// 646 bytes of a gzipped FileDescriptorProto
	,
}

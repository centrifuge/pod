...
func TestService_DeriveFromUpdatePayload(t *testing.T) {
	...
	p2 := &UpdateTransferDetailRequest{Data: createTestData(), Identifier: hexutil.Encode(utils.RandomSlice(32)), TransferId: p.Data.TransferId}
	...
	p3 := &UpdateTransferDetailRequest{Data: createTestData(), Identifier: hexutil.Encode(utils.RandomSlice(32)), TransferId: hexutil.Encode(utils.RandomSlice(32))}
...
func createTestPayload() *CreateTransferDetailRequest {
	return &CreateTransferDetailRequest{Identifier: "randomId", Data: createTestData()}
}

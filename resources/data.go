...
func goCentrifugeBuildConfigsDefault_configYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "go-centrifuge/build/configs/default_config.yaml", size: 6506, mode: os.FileMode(420), modTime: time.Unix(1559660522, 0)}

...
func goCentrifugeBuildConfigsDefault_configYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "go-centrifuge/build/configs/default_config.yaml", size: 6478, mode: os.FileMode(420), modTime: time.Unix(1558080996, 0)}

...
func TestRegister(t *testing.T) {
	...
	assert.Equal(t, r.Routes()[5].Pattern, "/documents/{document_id}/versions/{version_id}/funding_agreements/{agreement_id}")
	assert.NotNil(t, r.Routes()[5].Handlers["GET"])
	assert.Equal(t, r.Routes()[6].Pattern, "/entities")
	assert.Len(t, r.Routes()[6].Handlers, 1)
	assert.NotNil(t, r.Routes()[6].Handlers["POST"])
	assert.Equal(t, r.Routes()[7].Pattern, "/entities/{document_id}")
	assert.Len(t, r.Routes()[7].Handlers, 2)
	assert.NotNil(t, r.Routes()[7].Handlers["PUT"])
	assert.NotNil(t, r.Routes()[7].Handlers["GET"])
	assert.Equal(t, r.Routes()[8].Pattern, "/entities/{document_id}/revoke")
	assert.Len(t, r.Routes()[8].Handlers, 1)
	assert.NotNil(t, r.Routes()[8].Handlers["POST"])
	assert.Equal(t, r.Routes()[9].Pattern, "/entities/{document_id}/share")
	assert.NotNil(t, r.Routes()[9].Handlers["POST"])
	assert.Equal(t, r.Routes()[10].Pattern, "/invoices")
	assert.Len(t, r.Routes()[10].Handlers, 1)
	assert.NotNil(t, r.Routes()[10].Handlers["POST"])
	assert.Equal(t, r.Routes()[11].Pattern, "/invoices/{document_id}")
	assert.Len(t, r.Routes()[11].Handlers, 2)
	assert.NotNil(t, r.Routes()[11].Handlers["GET"])
	assert.NotNil(t, r.Routes()[11].Handlers["PUT"])
	assert.Equal(t, r.Routes()[12].Pattern, "/invoices/{document_id}/mint/unpaid")
	assert.NotNil(t, r.Routes()[12].Handlers["POST"])
	assert.Equal(t, r.Routes()[13].Pattern, "/invoices/{document_id}/versions/{version_id}")
	assert.NotNil(t, r.Routes()[13].Handlers["GET"])
	assert.Equal(t, r.Routes()[14].Pattern, "/purchase_orders")
	assert.Len(t, r.Routes()[14].Handlers, 1)
	assert.NotNil(t, r.Routes()[14].Handlers["POST"])
	assert.Equal(t, r.Routes()[15].Pattern, "/purchase_orders/{document_id}")
	assert.Len(t, r.Routes()[15].Handlers, 2)
	assert.NotNil(t, r.Routes()[15].Handlers["GET"])
	assert.NotNil(t, r.Routes()[15].Handlers["PUT"])
	assert.Equal(t, r.Routes()[16].Pattern, "/purchase_orders/{document_id}/versions/{version_id}")
	assert.NotNil(t, r.Routes()[16].Handlers["GET"])
	assert.Equal(t, r.Routes()[17].Pattern, "/relationships/{document_id}/entity")

...
func TestHandler_GetPurchaseOrderVersion(t *testing.T) {
	getHTTPReqAndResp := func(ctx context.Context) (*httptest.ResponseRecorder, *http.Request) {
		return httptest.NewRecorder(), httptest.NewRequest("GET", "/purchase_orders/{document_id}/versions/{version_id}", nil).WithContext(ctx)
	}

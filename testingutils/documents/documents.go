...
//}
//
//func (m *MockService) RequestDocumentSignature(ctx context.Context, model documents.Document, collaborator *types.AccountID) ([]*coredocumentpb.Signature, error) {
//	args := m.Called()
//	return args.Get(0).([]*coredocumentpb.Signature), args.Error(1)
//}
//
//func (m *MockService) ReceiveAnchoredDocument(ctx context.Context, model documents.Document, collaborator *types.AccountID) error {
//	args := m.Called()
//	return args.Error(0)
//}
//
...
//}
//
//func (m *MockModel) Author() (*types.AccountID, error) {
//	args := m.Called()
//	id, _ := args.Get(0).(*types.AccountID)
...
//}
//
//func (m *MockModel) GetCollaborators(filterIDs ...*types.AccountID) (documents.CollaboratorsAccess, error) {
...
//}
//
//func (m *MockModel) IsDIDCollaborator(did *types.AccountID) (bool, error) {
//	args := m.Called(did)

...
// Dispatch provides a mock function with given fields: acc, job
func (_m *DispatcherMock) Dispatch(acc identity.DID, job *gocelery.Job) (Result, error) {
	ret := _m.Called(acc, job)

	var r0 Result
	if rf, ok := ret.Get(0).(func(identity.DID, *gocelery.Job) Result); ok {
		r0 = rf(acc, job)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Result)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(identity.DID, *gocelery.Job) error); ok {
		r1 = rf(acc, job)
	} else {
		r1 = ret.Error(1)
	}
...
// Job provides a mock function with given fields: acc, jobID
func (_m *DispatcherMock) Job(acc identity.DID, jobID gocelery.JobID) (*gocelery.Job, error) {
	ret := _m.Called(acc, jobID)

	var r0 *gocelery.Job
	if rf, ok := ret.Get(0).(func(identity.DID, gocelery.JobID) *gocelery.Job); ok {
		r0 = rf(acc, jobID)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(identity.DID, gocelery.JobID) error); ok {
		r1 = rf(acc, jobID)
	} else {
		r1 = ret.Error(1)
	}
...
// Result provides a mock function with given fields: acc, jobID
func (_m *DispatcherMock) Result(acc identity.DID, jobID gocelery.JobID) (Result, error) {
	ret := _m.Called(acc, jobID)

	var r0 Result
	if rf, ok := ret.Get(0).(func(identity.DID, gocelery.JobID) Result); ok {
		r0 = rf(acc, jobID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Result)

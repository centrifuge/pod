...
// NewNodeAdminMock creates a new instance of NodeAdminMock. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNodeAdminMock(t testing.TB) *NodeAdminMock {
	mock := &NodeAdminMock{}
	mock.Mock.Test(t)

...
type NewAccountMockT interface {
	mock.TestingT
	Cleanup(func())
}

// NewAccountMock creates a new instance of AccountMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewAccountMock(t NewAccountMockT) *AccountMock {
	mock := &AccountMock{}
	mock.Mock.Test(t)

...
var (
	...
	pattern_FundingService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"document", "identifier", "extension", "funding", "funding_id"}, ""))
	...
	pattern_FundingService_GetVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"documents", "identifier", "version", "extension", "funding", "funding_id"}, ""))
	...
	pattern_FundingService_GetListVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 1, 0, 4, 1, 5, 2, 2, 3, 2, 4}, []string{"documents", "identifier", "version", "extension", "funding"}, ""))
)

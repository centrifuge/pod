...
func RegisterTransactionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TransactionServiceClient) error {
	...
	mux.Handle("GET", pattern_TransactionService_GetTransactionStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TransactionService_GetTransactionStatus_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_TransactionService_GetTransactionStatus_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

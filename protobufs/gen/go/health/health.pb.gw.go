...
func request_HealthCheckService_Ping_0(ctx context.Context, marshaler runtime.Marshaler, client HealthCheckServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterHealthCheckServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HealthCheckServiceClient) error {
	...
	mux.Handle("GET", pattern_HealthCheckService_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HealthCheckService_Ping_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_HealthCheckService_Ping_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_HealthCheckService_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"ping"}, ""))
)

var (
	forward_HealthCheckService_Ping_0 = runtime.ForwardResponseMessage
)

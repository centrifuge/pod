...
import fmt "fmt"
import math "math"
import accounts "github.com/centrifuge/go-centrifuge/protobufs/gen/go/accounts"
...
type ConfigData struct {
	...
	MainIdentity              *accounts.AccountData `protobuf:"bytes,20,opt,name=main_identity,json=mainIdentity,proto3" json:"main_identity,omitempty"`
...
func (*ConfigData) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_f8b8263cc1809d31, []int{0}
}
...
func (m *ConfigData) GetMainIdentity() *accounts.AccountData {
	if m != nil {
...
func init() { proto.RegisterFile("config/service.proto", fileDescriptor_service_f8b8263cc1809d31) }

var fileDescriptor_service_f8b8263cc1809d31 = []byte{
	// 802 bytes of a gzipped FileDescriptorProto
	,
}

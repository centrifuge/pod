...
// GetEntityRelationships provides a mock function with given fields: ctx, entityID
func (_m *ServiceMock) GetEntityRelationships(ctx context.Context, entityID []byte) ([]documents.Document, error) {

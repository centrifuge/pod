...
func (m *mockAnchorProcessor) RequestDocumentWithToken(ctx context.Context, requesterID identity.DID, tokenIdentifier, entityIdentifier, entityRelationIdentifier []byte) (*p2ppb.GetDocumentResponse, error) {
	args := m.Called(ctx, requesterID, tokenIdentifier, entityIdentifier, entityRelationIdentifier)

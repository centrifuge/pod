...
func (_m *ServiceMock) Commit(ctx context.Context, doc documents.Document) (gocelery.JobID, error) {
	ret := _m.Called(ctx, doc)

	var r0 gocelery.JobID
	if rf, ok := ret.Get(0).(func(context.Context, documents.Document) gocelery.JobID); ok {
		r0 = rf(ctx, doc)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, documents.Document) error); ok {
		r1 = rf(ctx, doc)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ServiceMock) CreateProofs(ctx context.Context, documentID []byte, fields []string) (*documents.DocumentProof, error) {
	ret := _m.Called(ctx, documentID, fields)

	var r0 *documents.DocumentProof
	if rf, ok := ret.Get(0).(func(context.Context, []byte, []string) *documents.DocumentProof); ok {
		r0 = rf(ctx, documentID, fields)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*documents.DocumentProof)
		}
	}
...
func (_m *ServiceMock) CreateProofsForVersion(ctx context.Context, documentID []byte, version []byte, fields []string) (*documents.DocumentProof, error) {
	ret := _m.Called(ctx, documentID, version, fields)

	var r0 *documents.DocumentProof
	if rf, ok := ret.Get(0).(func(context.Context, []byte, []byte, []string) *documents.DocumentProof); ok {
...
func (_m *ServiceMock) Derive(ctx context.Context, payload documents.UpdatePayload) (documents.Document, error) {
...
func (_m *ServiceMock) DeriveClone(ctx context.Context, payload documents.ClonePayload) (documents.Document, error) {
	ret := _m.Called(ctx, payload)
...
func (_m *ServiceMock) DeriveFromCoreDocument(cd *coredocumentpb.CoreDocument) (documents.Document, error) {
	ret := _m.Called(cd)

	var r0 documents.Document
	if rf, ok := ret.Get(0).(func(*coredocumentpb.CoreDocument) documents.Document); ok {
		r0 = rf(cd)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(documents.Document)
...
func (_m *ServiceMock) GetCurrentVersion(ctx context.Context, documentID []byte) (documents.Document, error) {
...
// GetEntityByRelationship provides a mock function with given fields: ctx, relationshipIdentifier
func (_m *ServiceMock) GetEntityByRelationship(ctx context.Context, relationshipIdentifier []byte) (documents.Document, error) {
	ret := _m.Called(ctx, relationshipIdentifier)

	var r0 documents.Document
	if rf, ok := ret.Get(0).(func(context.Context, []byte) documents.Document); ok {
		r0 = rf(ctx, relationshipIdentifier)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(documents.Document)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, []byte) error); ok {
		r1 = rf(ctx, relationshipIdentifier)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ServiceMock) GetVersion(ctx context.Context, documentID []byte, version []byte) (documents.Document, error) {
...
func (_m *ServiceMock) New(scheme string) (documents.Document, error) {
	ret := _m.Called(scheme)

	var r0 documents.Document
	if rf, ok := ret.Get(0).(func(string) documents.Document); ok {
		r0 = rf(scheme)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(documents.Document)
...
func (_m *ServiceMock) ReceiveAnchoredDocument(ctx context.Context, doc documents.Document, collaborator *types.AccountID) error {
	ret := _m.Called(ctx, doc, collaborator)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, documents.Document, *types.AccountID) error); ok {
...
func (_m *ServiceMock) RequestDocumentSignature(ctx context.Context, doc documents.Document, collaborator *types.AccountID) ([]*coredocumentpb.Signature, error) {
	ret := _m.Called(ctx, doc, collaborator)

	var r0 []*coredocumentpb.Signature
	if rf, ok := ret.Get(0).(func(context.Context, documents.Document, *types.AccountID) []*coredocumentpb.Signature); ok {
		r0 = rf(ctx, doc, collaborator)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, documents.Document, *types.AccountID) error); ok {
...
func (_m *ServiceMock) Validate(ctx context.Context, doc documents.Document, old documents.Document) error {
	ret := _m.Called(ctx, doc, old)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, documents.Document, documents.Document) error); ok {
		r0 = rf(ctx, doc, old)
	} else {
		r0 = ret.Error(0)
	}

...
func (m *mockService) Create(ctx *header.ContextHeader, inv documents.Model) (documents.Model, uuid.UUID, error) {
...
func TestGrpcHandler_Update_derive_fail(t *testing.T) {
	...
	srv.On("DeriveFromUpdatePayload", payload, mock.Anything).Return(nil, errors.New("derive error")).Once()

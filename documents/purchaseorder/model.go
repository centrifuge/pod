...
func (p *PurchaseOrder) AccountCanUpdate(updated documents.Model, account identity.DID) error {
	...
	err := p.CoreDocument.AccountCanUpdate(newPo.CoreDocument, account, p.DocumentType())
	if err != nil {
		return err
	}

...
//
//	testAccountMap map[testHostName]*testHost
//
...
//func (r *hostManager) getTestAccount(name testHostName) *testHost {
...
//func (r *hostManager) getHostTestSuite(t *testing.T, name testHostName) hostTestSuite {

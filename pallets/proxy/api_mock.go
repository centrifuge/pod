...
func (_m *APIMock) ProxyCall(ctx context.Context, delegator *types.AccountID, proxyKeyringPair signature.KeyringPair, forceProxyType types.Option[pkgproxy.CentrifugeProxyType], proxiedCall types.Call) (*centchain.ExtrinsicInfo, error) {

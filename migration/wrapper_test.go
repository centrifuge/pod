...
func TestAllMigrationsExistAsAssets(t *testing.T) {
	for k := range migrations {
		_, err := Asset(fmt.Sprintf("migration/files/%s.go", k))
		assert.NoError(t, err, "Missing Asset generated by go-bindata")
	}
}

...
func (_m *ServiceMock) InstanceMetadataOf(ctx context.Context, req *ItemMetadataOfRequest) (*types.InstanceMetadata, error) {
	ret := _m.Called(ctx, req)

	var r0 *types.InstanceMetadata
	if rf, ok := ret.Get(0).(func(context.Context, *ItemMetadataOfRequest) *types.InstanceMetadata); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.InstanceMetadata)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *ItemMetadataOfRequest) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}

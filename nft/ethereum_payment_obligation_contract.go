...
//
// Solidity: function mint(to address, tokenId uint256, tokenURI string, anchorId uint256, nextAnchorId uint256, properties bytes[], values bytes[], salts bytes32[], proofs bytes32[][]) returns()

...
// NewProxyAPIMock creates a new instance of ProxyAPIMock. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewProxyAPIMock(t testing.TB) *ProxyAPIMock {
	mock := &ProxyAPIMock{}
	mock.Mock.Test(t)

...
func (_m *ServiceMock) CreateIdentity(ctx context.Context, req *CreateIdentityRequest) (*CreateIdentityResponse, error) {
	ret := _m.Called(ctx, req)

	var r0 *CreateIdentityResponse
	if rf, ok := ret.Get(0).(func(context.Context, *CreateIdentityRequest) *CreateIdentityResponse); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*CreateIdentityResponse)
		}
	}
